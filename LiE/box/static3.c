...
static void check_torals(matrix* m, lie_Index r)
{ lie_Index i;
  if (m->ncols!=r+1)
...
static void check_Ww(vector* ww, lie_Index s)
...
static void check_Wws(matrix* m, lie_Index s)
...
static object groupmake(char lietype,lie_Index rank)
{ object result;
...
{ lie_Index r=Lierank(grp=g),n=d->intval;
...
{ lie_Index r=Lierank(grp=g),n=d->i.intval;
